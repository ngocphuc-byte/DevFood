...
import { onHandlerSideFood } from "../API/Food";
...
export default SideFood = () => {
    ...
    const onHandlerAddSideFood = () => {
        if(name.length==0){
            ...
            ToastAndroid.show('Món ăn phụ đã được thêm vào giỏ hàng',ToastAndroid.SHORT);
        }
    }
    
    useEffect(()=>{
        onHandlerSideFood(setData);
    },[])
    return(
        <View style={styles.container}>
                ...
                <View style={styles.containerDetail}>
                    <View style={styles.containerDetail2}>
                        ...
                        <TouchableOpacity style={styles.button} onPress={onHandlerAddSideFood}>
